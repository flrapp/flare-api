...
{
    Task CreateAsync(Guid projectId, CreateScopeDto dto, Guid currentUserId, string actorUsername);
    Task UpdateAsync(Guid scopeId, UpdateScopeDto dto, Guid currentUserId, string actorUsername);
